...
현재는 HTTP 설계를 마친 상태입니다. 2026년 7월 20일에는 MVC1의 웹 애플리케이션 이해 섹션부터 학습하며, Spring Boot 프로젝트는 MVC1 서블릿 섹션의 프로젝트 생성 강의를 마친 뒤 만듭니다.
...
Spring Boot 프로젝트는 MVC1 서블릿 섹션의 프로젝트 생성 강의를 마친 뒤 생성합니다. 생성 후 아래 명령으로 실행과 테스트 방법을 고정합니다.
...
- Java 21, Spring Web, Thymeleaf와 Test로 Spring Boot 프로젝트 생성
- Gradle Wrapper와 기본 패키지 `com.lemonade0209.minibank` 설정
