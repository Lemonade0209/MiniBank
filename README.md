...
HTTP 설계를 마치고 2026년 7월 21일에 Java 21, Spring Boot 3.5.16과 Gradle 8.14.3 기반 프로젝트를 생성했습니다. 서블릿 요청·응답 실습, Memory 회원 저장소와 중복 로그인 ID 검증을 구현했으며, FrontController 기반 MVC 프레임워크의 전반부 구조를 정리했습니다. 다음 학습 게이트는 MVC 프레임워크 만들기 후반입니다.
...
- [x] FrontController, ModelView와 ViewResolver 역할 정리
- [ ] 회원·계좌 Memory MVP
- [ ] 로그인·입출금 Memory MVP
- [ ] H2/JDBC 전환
- [ ] 이체 롤백과 동시 출금 테스트
